...
\begin{alltt}
 \hlkwd{require}\hlstd{(ars)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: ars}}\begin{alltt}
 \hlstd{dnorm1000} \hlkwb{<-} \hlkwd{ars}\hlstd{(}\hlnum{100}\hlstd{,}\hlkwc{g}\hlstd{=dnorm,}\hlkwc{D}\hlstd{=}\hlkwd{c}\hlstd{(}\hlopt{-}\hlnum{Inf}\hlstd{,}\hlnum{Inf}\hlstd{))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}ars"{}}}\end{kframe}
\end{knitrout}
